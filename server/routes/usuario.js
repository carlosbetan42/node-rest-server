...
app.post('/usuario', [verificaToken, verificaAdminRoles], async (req, res) => {
  const body = req.body;
...
app.put('/usuario/:id', [verificaToken, verificaAdminRoles], async (req, res) => {
...
app.delete('/usuario/:id', [verificaToken, verificaAdminRoles], async (req, res) => {
